...
with st.form('my_form'):
    questions = {
        ...
        "ten": "**10.บ่อยครั้งที่ท่านรู้สึกไม่มีที่พึ้ง**",
        "eleven": "**11.ท่านรู้สึกกระวนกระวาย หระสับกระส่ายบ่อยๆ**",
        "twelve": "**12.ท่านชอบอยู่กับบ้่านมากกว่าที่จะออกนอกบ้าน**",
...
# Scoring logic
if submitted:
    score_no = sum(1 for ans in answers.values() if ans == "ไม่ใช่")
